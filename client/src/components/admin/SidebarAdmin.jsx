...
const adminMenuLinks = [
  ...
  { name: "Manage Cars", path: "/admin/manage-cars", icon: assets.carIcon, coloredIcon: assets.carIconColored },
    ...
    <div className="relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm">
      <div className="group relative">
        <label htmlFor="admin-image">
          ...
          <input type="file" id="admin-image" accept="image/*" hidden onChange={(e) => setImage(e.target.files[0])} />
