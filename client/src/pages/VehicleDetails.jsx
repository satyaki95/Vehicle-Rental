...
const VehicleDetails = () => {
  ...
  const getRentalPrice = () => {
    ...
    switch (rentalDuration) {
      case "weekly":
        return vehicle.pricePerWeek || vehicle.pricePerDay * 7;
      case "monthly":
        return vehicle.pricePerMonth || vehicle.pricePerDay * 30;
      default:
  ...
  useEffect(() => {
    setVehicle(vehicles.find((item) => item._id === id));
  }, [vehicles, id]);
              ...
              {[
                {
                  ...
                  text: `${vehicle.seating_capacity} seats`,
                },
                {
